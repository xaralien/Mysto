            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                <?php if ($this->session->userdata('role_id') == 1) { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <h1 class="m-0 text-uppercase text-primary"><img class=" me-2"
                                src="<?= base_url('assets/'); ?>img/iconmysto.png" style="object-fit: cover;"></h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <a href="<?= base_url('activity/activity'); ?> " class="nav-item nav-link <?php if ($this->uri->segment(2) == "activity") {
                                   echo 'active';
                               } ?>">Activity</a>
                            ...
                            <!-- <a href="<?= base_url('storage/storage'); ?>" class="nav-item nav-link <?php if ($this->uri->segment(2) == "storage") {
                                  echo 'active';
                              } ?>">Storage</a> -->
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle <?php if ($this->uri->segment(2) == "storage") {
                                    echo 'active';
                            ...
                            if (!empty($this->session->userdata('email'))) {
                                if ($this->session->userdata('role_id') == 1) { ?>
                                    <a href="<?= base_url('storage/input_kategori'); ?>" class="dropdown-item">Sub Kategori Baru</a>
                                    <a href="<?= base_url('storage/pilih_kategori'); ?>" class="dropdown-item">Produk Baru</a>
                                    <?php }} ?>
                                    <a href="<?= base_url('storage/storage'); ?>" class="dropdown-item">Storage</a>
                                    <a href="<?= base_url('storage/history'); ?>" class="dropdown-item">History
                                        Storage</a>
                            ...
                            if (!empty($this->session->userdata('email'))) {
                                if ($this->session->userdata('role_id') == 1) { ?>
                                    ...
                                    <div class="nav-item dropdown">
                                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i style=""
                                        ...
                                        <div class="dropdown-menu m-0">
                                            ...
                                            <a href="<?= base_url('diagnosa/admin'); ?>" class="dropdown-item">Detail
                                                Diagnosa</a> -->
                                ...
                                <?php } else if ($this->session->userdata('role_id') == 2 or $this->session->userdata('role_id') == 3) { ?>
                                        ...
                                        <div class="nav-item dropdown ">
                                            ...
                                            <div class="dropdown-menu m-0">
                                                ...
                                                <a href="<?= base_url('diagnosa/user'); ?>" class="dropdown-item">Detail
                                                    Diagnosa</a> -->
