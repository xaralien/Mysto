        ...
        <div class="row gx-5">
            <div class="col-lg-6">
                <div class="bg-white text-center rounded p-5">
                    <h1 class="mb-4">Input Nama Kategori</h1>
                    <form method="post" action="<?= base_url('storage/proses_kategori/'); ?>">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <select class="form-select bg-light border-0" style="height: 55px;" name="id_kategori">
                                    ...
                                    <?php foreach ($kategori as $k) {
                                        ...
                                        $kate = $k->nama_kategori;
                                        ?>

                                        <option value="<?= $id_kate ?>"><?= $id_kate ?> - <?= $kate ?></option>
                            ...
                            <div class="col-12 ">
                                <label style="float: left; " for=""><b>Nama Sub Kategori</b> </label>

                                <input type="text" class="form-control border-0" name="nama_sub"
                                    placeholder="Masukan Nama Sub Kategori . . .">
                                <hr style="margin-top: -5px;">
                            </div>
                            <!-- <div class="col-12 ">
                                <label style="float: left; " for=""><b>Berat Produk Satuan (Gram)</b> </label>
                              
                                <input type="number" class="form-control border-0" name="berat_produk"
                                    placeholder="Masukan Berat Produk . . ." min="1">
                                <hr style="margin-top: -5px;">
                            </div>
                            <div class="col-12 ">
            ...
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="mb-4">
                    ...
                    <h1 class="display-4">Isi Detail Kategori dan Sub Kategori</h1>
                </div>
                <p class="text-black mb-5">
                    Masukan Nama Sub Kategori sesuai dengan produk yang anda masukkan.
                </p>
