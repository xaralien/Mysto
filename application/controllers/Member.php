        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if ($user['role_id'] == 1) {
                        redirect('home/admin');
                    } else if ($user['role_id'] == 2 or $user['role_id'] == 3) {
                        redirect('home');
                    } else {
                ...
                $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">Email Belum diaktifasi!!</div>');
                $this->load->view('templates/login');
            }
        } else {
            $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">Email dan Password tidak terdaftar!!</div>');
            $this->load->view('templates/login');
        }
    }
